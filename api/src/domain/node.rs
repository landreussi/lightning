...
#[diesel(table_name = crate::repository::schema::nodes)]
...
impl Node {
    ...
    pub const UNKNOWN: &str = "0279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798";
    ...
    /// A node under the key no ranking answers with, for the cases that must
    /// not collide with a row the database may already hold.
    pub fn unknown(satoshis: i64, first_seen: OffsetDateTime) -> Self {
        Self::fixture(Self::UNKNOWN, "unknown", satoshis, first_seen)
    }
